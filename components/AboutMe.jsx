...
const AboutMe = () => {
  return (
    <section className=" border-t-2 border-gray-600 " >
        <h1 className="text-center text-5xl font-bold font-palanquin max-sm:text-3xl max-md:text-4xl mt-6 dark:text-gray-300 text-slate-600">About Me</h1>
        <div className="flex md:flex-row md:mt-10 flex-col gap-11 mt-24 mb-16 ">
